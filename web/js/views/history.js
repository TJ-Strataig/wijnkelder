...
const ACTION_LABELS = {
  ...
  'passkey.added': 'voegde een passkey toe', 'passkey.removed': 'verwijderde een passkey', 'ai.recognize': 'liet een etiket herkennen', 'ai.price': 'haalde een prijsindicatie op', 'ai.settings': 'wijzigde de AI-instellingen', 'producer.profiled': 'vroeg een wijnhuisprofiel op', 'wine.created_consumed': 'voegde een al gedronken wijn toe aan de historie', 'bottles.added_consumed': 'voegde een gedronken fles toe aan de historie', 'chat.message': 'sprak met de Sommelier', 'chat.offtopic': 'kreeg een niet-wijnvraag geweigerd door de Sommelier', 'inventory.finished': 'rondde een inventarisatie af', 'ai.restaurant': 'liet een wijnkaart lezen', 'intake.added': 'zette een foto in de beoordelingswachtrij', 'intake.approved': 'keurde een fles uit de wachtrij goed', 'intake.removed': 'verwijderde een item uit de wachtrij', 'intake.cleanup': 'ruimde de wachtrij op', 'wine.located': 'plaatste een wijn op de kaart',
};
